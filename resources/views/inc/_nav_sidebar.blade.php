...
<aside class="main-sidebar elevation-4 sidebar-light-primary">
    ...
    <a href="#" class="brand-link">
        <img src="{{ asset('img/appointments1.png') }}" alt="Logo AdminLTE" class="brand-image img-circle elevation-3"
            style="max-height: 38px; opacity: .8">
        <span class="brand-text font-weight-light"><b>Clinique</b> Tlemcen</span>
    </a>
